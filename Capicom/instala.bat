...
if NOT EXIST %windir%\System32\CobreBemX.dll copy CobreBemX.dll %windir%\System32
ECHO *** Registrando as DLLs ***
regsvr32 %windir%\System32\capicom.dll /s
regsvr32 %windir%\System32\msxml5.dll /s
regsvr32 %windir%\System32\CobreBemX.dll /s
goto end
...
if NOT EXIST %windir%\SysWOW64\CobreBemX.dll copy CobreBemX.dll %windir%\SysWOW64
ECHO *** Registrando as DLLs x64 ***
regsvr32 %windir%\SysWOW64\capicom.dll /s
regsvr32 %windir%\SysWOW64\msxml5.dll /s
regsvr32 %windir%\SysWOW64\CobreBemX.dll /s
goto end
